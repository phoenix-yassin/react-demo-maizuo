/**
 * Create by zechun.chen on 2016/12/27
 */

//公共
export const COM_LOADING_STATUS = 'COM_LOADING_STATUS'
export const COM_CONF = 'COM_CONF'
export const CHANGE_LEFTNAV_STATUS = 'CHANGE_LEFTNAV_STATUS' //左侧导航切换
...
export const CHANGE_NOWPLAYING_MORE = 'CHANGE_NOWPLAYING_MORE' //是否可以获取更多热映
export const CHANGE_COMING_MORE = 'CHANGE_COMING_MORE' // 是否可以获取更多即将上映
